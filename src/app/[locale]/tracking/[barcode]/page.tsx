            ...
            <ul className="timeline mt-10 flex flex-col p-6 md:flex-row">
              {sortedRoute.map((route, ind) => {
                ...
                return (
                  <li
                    key={ind}
                    className={`relative h-[100px] px-8 md:px-0 ${isAr ? "before:right-0 before:translate-x-[100%] before:translate-y-[50%] md:before:translate-x-[50%] md:before:translate-y-[0%]" : ""} md:h-fit md:min-w-[250px] md:pt-8 md:pl-0 ${ind !== timelineLength - 1 && timelineBorders}`}
                  >
