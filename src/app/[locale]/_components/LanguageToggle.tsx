...
import { satoshi, NNA } from "../../fonts/fonts";
export default function LanguageToggle() {
  ...
  const fontClass = !isArabic ? NNA.className : satoshi.className + " tracking-tight";
  ...
  return (
    <>
      ...
      >
        ...
        <span className={`${fontClass} sm:hidden md:inline-block`}>{!isArabic ? "ع" : "En"}</span>
      </button>
    </>
  );
}
